...
def compute_fMap(self, files, ppm, chunk_size, window_type, low_speed, high_speed, **kwargs):
    ...
    for key, value in freq_ranges.items():
        ...
        maps, scaling_factor = compute_freq_map(self, key, window_type, pos_x, pos_y, pos_t, fs, chunks, chunk_size, 100, 16, 4, scaling_factor=scaling_factor)
        freq_maps[key] = maps
    ...
    return freq_maps, scaling_factor, new_pos_t
...
# maps = compute_fMap(files, 585, 30, 'hamming', 0, 100, scaling_factor=163156718.83084807)